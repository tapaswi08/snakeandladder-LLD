    ...
    private void initBoard() {
        ...
        for (int i = 0; i < numberOfSnakes; i++) {
            while (true) {
                ...
                int snakeStart = rand.nextInt(board.getStart(), board.getSize());
                int snakeEnd = rand.nextInt(board.getStart(), board.getSize());
        ...
        for (int i = 0; i < numberOfLadders; i++) {
            while (true) {
                Random rand = new Random();
                int ladderStart = rand.nextInt(board.getStart(), board.getSize());
                int ladderEnd = rand.nextInt(board.getStart(), board.getSize());
